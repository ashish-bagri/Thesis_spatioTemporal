...
{
	int x = static_cast<int>(cvRound(xScale * getLeft()));
	int y = static_cast<int>(cvRound(yScale * getTop()));
	int x2 = static_cast<int>(cvRound(xScale * getRight()));
	int y2 = static_cast<int>(cvRound(yScale * getBottom()));
	setCoords(x, y, x2, y2);
}
...
{
	long x = static_cast<long>(cvRound(xScale * getLeft()));
	long y = static_cast<long>(cvRound(yScale * getTop()));
	long x2 = static_cast<long>(cvRound(xScale * getRight()));
	long y2 = static_cast<long>(cvRound(yScale * getBottom()));
	setCoords(x, y, x2, y2);
}
...
{
	Box<int> box;
	box.setCoords(static_cast<int>(cvRound(getLeft())), static_cast<int>(cvRound(getTop())), 
			static_cast<int>(cvRound(getRight())), static_cast<int>(cvRound(getBottom())));
	return box;
}
...
{
	Box<long> box;
	box.setCoords(static_cast<long>(cvRound(getLeft())), static_cast<long>(cvRound(getTop())), 
			static_cast<long>(cvRound(getRight())), static_cast<long>(cvRound(getBottom())));
	return box;
}
